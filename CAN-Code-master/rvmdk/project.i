...
int  main(void) {	
	...
	GPIOPinTypeGPIOInput(0x40004000, 0x00000010);

	IntMasterEnable(); 
	GPIOIntEnable(0x40004000, 0x00000010); 
	GPIOIntRegister(0x40004000,*encoderAInterrupt); 
	GPIOIntTypeSet(0x40004000,0x00000010,0x00000004); 
	
	
	SysCtlPeripheralEnable(0xf0004000);
	
	GPIOPinConfigure(0x00011804);
	GPIOPinTypePWM(0x40005000, 0x00000040);
	
	
	while(!SysCtlPeripheralReady(0xf0000800) || !SysCtlPeripheralReady(0xf0000801) || !SysCtlPeripheralReady(0xf0000802) || !SysCtlPeripheralReady(0xf0000803) || !SysCtlPeripheralReady(0xf0000804) || !SysCtlPeripheralReady(0xf0000805) || !SysCtlPeripheralReady(0xf0004000))
	{
	
	}
    
	
	PWMGenConfigure(0x40028000, 0x00000040, 0x00000000 | 0x00000000);
	
	
	PWMGenPeriodSet(0x40028000, 0x00000040, 400);
	PWMPulseWidthSet(0x40028000, 0x00000040, 100);
	
	PWMGenEnable(0x40028000, 0x00000040);
	
	PWMOutputState(0x40028000, (0x00000001), 1);
...
{	
		...
		PWMPulseWidthSet(0x40028000, 0x00000040, speedSet);
...
{
	count++;
	GPIOIntClear(0x40004000, 0x00000010);
